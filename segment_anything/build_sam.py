...
def build_sam_vit_h(args, image_size, num_classes, chunk, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam(
        args, 
...
def build_sam_vit_b(args, image_size, num_classes, chunk, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None):
    return _build_sam(
        args,
